 ...
 * Provides vertex shader for fluent design backplate material with blob effects and rounded corners
 */

/**
 * Shader name identifier
 */
export const SHADER_NAME = "fluentBackplateVertexShader";

/**
 * Complete GLSL vertex shader source code for fluent backplate effect
 * 
 * Features:
 * - Rounded rectangle corners with configurable radii
 * - Blob proximity effects (up to 2 simultaneous blobs)
 * - Iridescence and highlighting
 * - Edge anti-aliasing
 * - Global hand tracking integration
 */
export const FLUENT_BACKPLATE_VERTEX_SHADER = `
uniform mat4 world;
...
/**
 * Shader registration object
 */
export interface FluentBackplateShaderExport {
...
/**
 * Exported shader configuration for Babylon.js ShaderStore
 */
export const fluentBackplateVertexShader: FluentBackplateShaderExport;