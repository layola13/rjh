...
class PlatformInfoCollector extends BaseCollector {
  static collecterName = "platformInfo";
  static graphicsCard: GraphicsCardInfo | null = getGraphicsCard();
  ...
  getLogParams(): PlatformLogParams {
    ...
    PlatformInfoCollector.graphicsCard = 
      PlatformInfoCollector.graphicsCard ?? getGraphicsCard();
