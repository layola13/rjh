/**
 * Medium Workmark Icon Configuration
 * 
 * Defines the SVG icon structure for the Medium workmark logo.
 * This icon is used in the Ant Design icon system.
 * 
 * @module MediumWorkmarkIcon
 */
...
/**
 * Medium Workmark icon definition
 * 
 * This icon displays the Medium platform's workmark logo in outlined style.
 * The SVG path data represents the complete Medium wordmark with proper proportions.
 * 
 * @constant
 * @type {IconDefinition}
 */
const MediumWorkmarkIcon: IconDefinition = {
  icon: {
    tag: 'svg',
    attrs: {
...
export default MediumWorkmarkIcon;