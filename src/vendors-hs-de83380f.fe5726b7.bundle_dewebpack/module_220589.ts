...
const IconReact = (props: IconReactProps): React.ReactElement | null => {
  const {
    icon,
    className,
    onClick,
...
IconReact.getTwoToneColors = (): TwoToneColors => {
  return { ...twoToneColorPalette };
};

IconReact.setTwoToneColors = (colors: { primaryColor: string; secondaryColor?: string }): void => {
