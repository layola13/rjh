...
export interface RubyIconDefinition {
  icon: Icon;
  name: string;
  theme: string;
}

const rubyIcon: RubyIconDefinition = {
  icon: {
    tag: "svg",
    attrs: {
      "fill-rule": "evenodd",
