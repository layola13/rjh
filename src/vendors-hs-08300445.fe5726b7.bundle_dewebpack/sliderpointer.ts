...
interface SliderPointerStyles {
  picker: PickerStyle;
}

interface StyleConfig {
  default: SliderPointerStyles;
}

const PICKER_WIDTH = '14px';
const PICKER_HEIGHT = '14px';
const PICKER_BORDER_RADIUS = '6px';
const PICKER_TRANSFORM = 'translate(-7px, -1px)';
const PICKER_BACKGROUND_COLOR = 'rgb(248, 248, 248)';
const PICKER_BOX_SHADOW = '0 1px 4px 0 rgba(0, 0, 0, 0.37)';

export const SliderPointer = (): JSX.Element => {
