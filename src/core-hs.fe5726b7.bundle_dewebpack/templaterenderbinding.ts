...
export const TEMPERATURE_NAME = Object.assign(
  {
    NATURE: "day-nature",
    WARM: "day-warm",
...
export const TEMPLATE_NAME_V3 = Object.assign(
  {
...
export const RenderTemplate: Readonly<Record<string, TemplateConfig>> = {
